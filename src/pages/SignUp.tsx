...
import { BookOpen, Mail, Lock, User as UserIcon, ArrowRight, MapPin } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-[#e5e5e0] w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#1a1a1a]">Join Libris</h1>
          <p className="text-sm text-[#9e9e9e] mt-2">Start your exchange journey today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <UserIcon className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[#9e9e9e]" />
              <input 
                required
                type="text" 
        ...
        <p className="text-center mt-8 text-sm text-[#4a4a4a]">
          ...
          <Link to="/login" className="text-[#5A5A40] font-bold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
